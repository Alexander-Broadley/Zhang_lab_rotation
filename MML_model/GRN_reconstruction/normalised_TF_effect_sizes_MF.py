...
#load and filter dataset to ensure only iterating through releveant genes
...
for target in gene_expressions.columns:
    ...
    results_df.to_csv(f'./data/differential_relative_effect_sizes_norm/{target}_DRE.csv')