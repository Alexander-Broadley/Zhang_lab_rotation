...
print(f'Before subsetting to external GE has shape {gene_expressions.shape}')

#to get validation on external dataset to be more fair filter to only genes in the external dataset
...
print(f'After subsetting to external GE has shape {gene_expressions.shape}')
...
train_actual.to_csv(f'{DATA_ROOT}/Train_dataset_actual_expressions_EXPERIMENTAL.csv')
train_predicted.to_csv(f'{DATA_ROOT}/Train_dataset_predicted_expressions_EXPERIMENTAL.csv')

test_actual.to_csv(f'{DATA_ROOT}/Test_dataset_actual_expressions_EXPERIMENTAL.csv')
test_predicted.to_csv(f'{DATA_ROOT}/Test_dataset_predicted_expressions_EXPERIMENTAL.csv')
