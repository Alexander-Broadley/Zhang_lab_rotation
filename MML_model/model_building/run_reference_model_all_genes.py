...
#import model
from model_building.referenceModel import referenceModel
...
for target_gene in gene_expressions.columns:
    ...
    torch.save(model, f'../models/reference_models/{target_gene}_model.pth')

train_actual.to_csv(f'{DATA_ROOT}/Train_dataset_actual_expressions_REFERENCE.csv')
train_predicted.to_csv(f'{DATA_ROOT}/Train_dataset_predicted_expressions_REFERENCE.csv')

test_actual.to_csv(f'{DATA_ROOT}/Test_dataset_actual_expressions_REFERENCE.csv')
test_predicted.to_csv(f'{DATA_ROOT}/Test_dataset_predicted_expressions_REFERENCE.csv')


results_df.to_csv('data/reference_results.csv')